...
HELP_SECTIONS = [
    ...
    },
    {
        ...
        "notes": [
            ...
            "Jika semua kandidat feeder tetap bentrok, kolom Notes akan menandai conflict untuk dicek manual.",
            "Mode CM602 Program File Converter to CM.txt membaca BoardData, BlockData, dan PartsData lalu membuat file tab-delimited CM.txt tanpa header.",
            "Kolom mirror X/Y pada CM.txt dihitung dari ukuran board dikurangi koordinat mount, dan angle negatif dinormalisasi ke 0-360.",
            "Mode Excel to CM602 FeederFix TXT membaca Excel dua kolom: Location Code seperti [1]7L dan Part Number.",
            "Mode itu menggabungkan posisi L/R menjadi satu row FeederFix per BeamNo + PU, lalu mengisi FeederA/FeederB dan PartsA/PartsB seperti 45-FIX.txt.",
    ...
    {
        "title": "CRB Program Collector",
        "subtitle": "Cari file program .crb berdasarkan PCB part number lalu copy ke satu folder.",
        "steps": [
            "Buka Other Tools lalu pilih CRB Program Collector.",
            "Pilih Source Folder yang berisi program .crb.",
            "Pilih Destination Folder untuk menampung hasil copy.",
            "Isi PCB Part Number satu per baris.",
            "Isi Line Filter jika hanya ingin line tertentu, contoh INI3, INI4; kosongkan untuk semua line.",
            "Klik Scan, cek hasil/report, lalu klik Copy.",
        ],
        "notes": [
            "Scan dilakukan recursive dan hanya memproses file .crb.",
            "Part number dicocokkan ke full path/nama file secara case-insensitive.",
            "Line filter juga case-insensitive, dan INI4 tidak akan match ke INI40.",
            "Copy tidak overwrite file lama; nama duplikat dibuat unik otomatis dan ukuran file diverifikasi.",
            "Report bisa diexport ke .txt atau .csv.",
        ],
    },
    {
    ...
    {
        "title": "PCB Fix Feeder Groups",
        "subtitle": "Kelompokkan folder PCB berdasarkan kemiripan component usage gabungan dari sheet BOM.",
        "steps": [
            "Buka Other Tools lalu pilih PCB Fix Feeder Groups.",
            "Pilih Folder Induk PCB yang berisi subfolder PCB.",
            "Aplikasi mengumpulkan semua component dari semua Excel program di tiap folder PCB, lalu menghapus duplicate.",
            ...
            "Gunakan filter GROUPED untuk melihat PCB yang cocok digabung, atau SHOW ALL untuk melihat single PCB.",
            "Export Excel untuk menyimpan Recommended Groups, Group Components, Pair Similarity, PCB Components, dan Scan Log.",
        ],
        "notes": [
            "Similarity dihitung dari jumlah component yang sama dibanding folder PCB dengan jumlah component lebih kecil.",
            ...
            "Output memakai PCB Part Number saja, tanpa Model Part Number EBU, EBT, atau EBR.",
        ],
    },
    {
