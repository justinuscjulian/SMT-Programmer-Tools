...
from services.average_insert_component_service import (
    AverageInsertComponentConfig,
    generate_average_insert_component,
    suggest_output_name,
)
from services.used_part_component_service import MODE_PCB_LIST, MODE_PROGRAM_FOLDER
from ui.pages.base import WorkerPage
from widgets.card import Card
from widgets.file_picker import FilePicker


class AverageInsertComponentPage(WorkerPage):
    ...
    def _build_ui(self):
        ...
        self.generate_btn = QPushButton("Generate AVG Insert Excel")
    ...
    def generate_excel(self):
        ...
        output_path, _ = QFileDialog.getSaveFileName(
            self,
            "Save Used Part Component AVG Insert",
        ...
        self.run_worker(
            lambda: generate_average_insert_component(config),
            self._on_generate_done,
            "Generating Used Part AVG Insert...",
        )
    ...
    def _config(self, output_path):
        return AverageInsertComponentConfig(
